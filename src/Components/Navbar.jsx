...
function Navbar() {
  ...
  return (
    <div className="w-full fixed z-[999] ">
      <div className=" max-w-screen-xl mx-auto px-5 py-10 sm:px-10 sm:py-10 flex items-center justify-between text-white ">
        <motion.div
          initial={{ opacity: 0 }}
        ...
        >
          <div className="">
            <ul className="flex sm:hidden flex-col gap-5  ">
